...
export function ArbitragePanel({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  }, [open, tab, fetchStatus, fetchTrades]);
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/50 p-4" onClick={onClose}>
      <div className="flex max-h-[90vh] w-full max-w-5xl flex-col rounded-2xl border border-line bg-surface-elevated shadow-xl overflow-hidden" onClick={(e) => e.stopPropagation()}>
        {/* Header */}
